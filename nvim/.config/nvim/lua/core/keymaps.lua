...
map(
	"n",
	"<leader>dd",
	'<cmd>NvimTreeClose<CR><cmd>lua require("dapui").open()<CR><cmd>lua require("dap").continue()<CR>'
)
map(
	"n",
	"<leader>de",
	'<cmd>lua require("dapui").close()<CR><cmd>lua require("dap.breakpoints").clear()<CR><cmd>NvimTreeOpen<CR><C-l>'
)
