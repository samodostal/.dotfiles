return function()
	...
	local servers = { "efm", "sumneko_lua", "ansiblels", "bashls", "clangd", "cmake", "cssls", "dockerls", "gopls", "golangci_lint_ls", "graphql", "hls", "html", "jsonls", "pyright", "rust_analyzer", "tailwindcss", "tsserver", "yamlls" }
